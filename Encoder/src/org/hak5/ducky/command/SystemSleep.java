 ...
 *
 * Implementation of the <code>SYSTEMSLEEP</code> command. Used to put the
 * computer to sleep.
 */
public class SystemSleep implements Command {
    public final java.lang.String name    = "SYSTEMSLEEP";
